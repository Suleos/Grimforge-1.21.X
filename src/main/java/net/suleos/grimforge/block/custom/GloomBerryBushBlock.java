...
public class GloomBerryBushBlock extends SweetBerryBushBlock {
    public GloomBerryBushBlock(Settings settings) {
        super(settings);
    }

    @Override
    public ItemStack getPickStack(WorldView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModItems.GLOOM_BERRIES);
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            dropStack(world, pos, new ItemStack(ModItems.GLOOM_BERRIES, j + (bl ? 1 : 0)));
